...
?>
                    ...
                    <div class="container">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                $query_run = mysqli_query($con, "select * from booked_flight");
                                ?>
                                    ...
                                    ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['depture_d']; ?></td>
                                                    <td><?php echo $row['arrival_d']; ?></td>
                                                    <td><?php echo $row['seats']; ?></td>
                                                    <td><?php echo $row['price']; ?></td>
                                                    <td><b>Pessenger Flight Info:</b><br>
                                                        Travel Class=<?php echo $row['travel_class']; ?><br>
                                                        children=<?php echo $row['children']; ?><br>
                                                        Adults=<?php echo $row['adults']; ?><br>

                                                        <b>Pessenger Personal Info:</b><br>
                ...
                <form method="POST" action="">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="att" id="att" class="form-control" placeholder="Airport To Take" required>
                        </div>
    ...
    if (isset($_POST['editdata'])) {
        ...
        $u = mysqli_query($con, "update booked_flight set plane_no='$plane_no', flight_name='$airline_nm', airport_from='$airport_tt' ,airport_to='$airport_tl', depture_d='$departure_d2', arrival_d='$arrival_d2', seats='$seats', price='$price', date='$date2'
        where id='$id' ");
    ...
    if (isset($_POST['deletedata'])) {
        ...
        $d = mysqli_query($con, "delete from booked_flight where id='$id'");
    }
    ?><?php
    } else {
